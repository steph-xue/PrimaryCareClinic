...
- As a user, I want to be able to add clinical notes to a patient's record with details such as the title (reason for visit), body (note details), name of the healthcare provider seen, and date
